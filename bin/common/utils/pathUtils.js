...
export const isNameTooLong = (str) => 
 ...
 */
export function toMessageRelativeFilePath(filePath) {
 ...
 */
export function aliasedSitePath(filePath, siteDir) {
...
export function addTrailingPathSeparator(str) {
