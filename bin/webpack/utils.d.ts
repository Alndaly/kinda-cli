 ...
 */
export declare function applyConfigureWebpack(configureWebpack: NonNullable<any['configureWebpack']>, config: Configuration, isServer: boolean, jsLoader: 'babel' | ((isServer: boolean) => RuleSetRule) | undefined, content: unknown): Configuration;
export declare function applyConfigurePostCss(configurePostCss: NonNullable<any['configurePostCss']>, config: Configuration): Configuration;
declare global {
    interface Error {
