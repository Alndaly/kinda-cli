...
import { getFileLoaderUtils } from 'src/common/utils/index.js';
import MiniCssExtractPlugin from 'mini-css-extract-plugin';
import { getStyleLoaders, getCustomizableJSLoader, getCustomBabelConfigFilePath, getMinimizer } from './utils.js';
...
export function excludeJS(modulePath) {
...
export async function createBaseConfig(props, isServer, minify = true) {
